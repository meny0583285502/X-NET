...
$trayLines.Add('$lastSyncCheck = Get-Date')
$trayLines.Add('$timer.add_Tick({')
$trayLines.Add('    Update-Tray')
$trayLines.Add('    # Watchdog: if sync log not updated in 3 min, trigger sync')
$trayLines.Add('    $logFile = "C:\XNET\sync_log.txt"')
$trayLines.Add('    if (Test-Path $logFile) {')
$trayLines.Add('        $logAge = (Get-Date) - (Get-Item $logFile).LastWriteTime')
$trayLines.Add('        if ($logAge.TotalMinutes -gt 3) {')
$trayLines.Add('            Start-Process powershell -ArgumentList "-WindowStyle Hidden -Command schtasks /run /tn XNET_Sync" -Verb RunAs -ErrorAction SilentlyContinue')
$trayLines.Add('        }')
$trayLines.Add('    }')
$trayLines.Add('})')
$trayLines.Add('$timer.Start(); Update-Tray')
